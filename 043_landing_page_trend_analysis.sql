-- Assignment_Landing_Page_Trending   
...
SELECT
    ...
    COUNT(DISTINCT CASE WHEN count_pageviews = 1 THEN website_session_id ELSE NULL END)*1.0/COUNT(DISTINCT website_session_id) AS total_sessions,
